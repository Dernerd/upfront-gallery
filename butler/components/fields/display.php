...
function butler_do_input_repeater( $field, $i ) {
	...
	echo '<a href="#" class="btr-repeat button button-small">Neue hinzufügen</a>';
...
function butler_do_input_image( $field ) {
	...
	echo '<a href="#" class="btr-upload-image button button-small' . ( $img ? ' hide' : '' ) . '">Bild hinzufügen</a>';
...
function butler_do_input_gallery( $field ) {
	...
	echo '<a href="#" class="btr-upload-image button button-small">Bild hinzufügen</a><span class="drag-notice"> Zum Ordnen per Drag & Drop verschieben</span>';
