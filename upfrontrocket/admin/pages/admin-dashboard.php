...
<div class="wrap pur-dashboard pur-page">
	...
	<div id="switcher" class="uk-switcher">
		<div><!-- dashboard -->
			<div class="uk-grid"><!-- grid -->
				...
				<div class="uk-width-large-1-3 btr-panel sign-up">
					...
					<div class="btr-panel-content">
						<p>Sign up to get notified when we release new UpFront goodies and product updates.</p>
						<form action="http://UpFrontrocket.us5.list-manage.com/subscribe/post?u=5634a864e7429fd035bd71b21&amp;id=3a9b303fe3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
		...
		<div> <!-- settings -->
			<?php butler_options_meta_boxes( UPFRONTROCKET_PARENT_MENU ) ?>
		</div><!-- close settings -->
	</div>
</div>